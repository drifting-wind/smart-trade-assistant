...
import com.example.multiai.model.AiChatModel;
...
public class ChatOrchestrationService {
    ...
    public Mono<ChatResponse> complete(ChatRequest request) {
        ...
        //ChatRequest request, List<AiPromptMessage> memory, String systemPrompt
     ...
     */
    private Flux<com.example.multiai.model.AiToken> streamWithFallback(AiPromptRequest prompt, RouteDecision route) {
